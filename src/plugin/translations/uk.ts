...
export const language: i18n =
{
	...
	settings:
	{
		...
		backlinks: {
			...
			info_placeInRightSidebar: "Розмістити зворотні посилання у правій бічній панелі замість підвалу (з'являється під змістом)."
		},
		tags: {
			title: "Теги",
			description: "Відображає теги для поточного відкритого документа.",
			info_showInlineTags: "Показувати теги, визначені всередині документа, у верхній частині сторінки.",
			info_showFrontmatterTags: "Показувати теги, визначені у frontmatter документа, у верхній частині сторінки."
		},
		frontmatterProperties: {
			title: "Властивості",
			description: "Відображає властивості frontmatter для поточного відкритого документа.",
			info_showFrontmatterProperties: "Показувати властивості, визначені у frontmatter документа, у верхній частині сторінки."
		},
		aliases: {
			title: "Псевдоніми",
