...
export const language: i18n =
{
	...
	exportModal:
	{
		...
		siteName:
		{
			title: "Назва сайту / файлу",
			description: "Використовується як назва експортованого сайту та ім'я одного HTML-файлу.",
			required: "Перед експортом потрібно вказати назву сайту.",
		},
		filePicker:
		{
