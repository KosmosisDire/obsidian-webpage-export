...
export const language: i18n = 
{
	...
	exportModal: 
	{
		...
		purgeExport:
		{
			description: "Очистити кеш сайту для повторного експорту всіх файлів або повністю видалити сайт з усіма його файлами.",
			clearCache: "Очистити кеш",
			purgeSite: "Очистити та видалити",
			...
			purgeWarning: "Це видалить весь експортований сайт і всі його файли.\n\nЦю дію неможливо скасувати."
		},
	},
	settings: 
	{
