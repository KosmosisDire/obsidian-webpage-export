...
// 		this.webpageJS = await this.assetsPath.joinString("webpage.txt.js").readFileString() ?? "";
// 		this.graphViewJS = await this.assetsPath.joinString("graph_view.txt.js").readFileString() ?? "";
// 		this.graphWASMJS = await this.assetsPath.joinString("graph_wasm.txt.js").readFileString() ?? "";
// 		this.graphWASM = await this.assetsPath.joinString("graph_wasm.txt.wasm").readFileBuffer() ?? Buffer.from([]);
// 		this.renderWorkerJS = await this.assetsPath.joinString("graph-render-worker.txt.js").readFileString() ?? "";
// 		this.tinyColorJS = await this.assetsPath.joinString("tinycolor.txt.js").readFileString() ?? "";
// 	}
